...
5. Writing a library for Arduino | Arduino Documentation. (n.d.). [https://docs.arduino.cc/learn/contributions/arduino-creating-library-guide/](https://docs.arduino.cc/learn/contributions/arduino-creating-library-guide/)